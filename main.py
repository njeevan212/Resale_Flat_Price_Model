...
data = pd.read_csv('/home/jeeva/Projects/python/Resale_Flat_Price_Model/data/df_coordinates.csv')
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"/home/jeeva/Projects/python/Resale_Flat_Price_Model/model.pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r'/home/jeeva/Projects/python/Resale_Flat_Price_Model/scaler.pkl', 'rb') as f:
